...
const TxPage = (() => {
    ...
    async function downloadReceipt(txId) {
        ...
        try {
            ...
            doc.setFontSize(9);
            doc.setTextColor(255, 255, 255);
            doc.text('West Haven Bank  •  support@West Haven Bank.com  •  West Haven Bank.com', W / 2, pH - 16, { align: 'center' });

            const ref  = t.transaction_reference || t.id.slice(0, 8);
            doc.save(`West Haven Bank-receipt-${ref}.pdf`);
    ...
    async function exportStatement() {
        ...
        try {
            ...
            doc.save(`West Haven Bank-statement-${currentUser.first_name}-${dateStr}.pdf`);
