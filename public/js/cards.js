...
function formatCardBalance(amount) {
    if (typeof helpers !== 'undefined' && typeof helpers.formatUSDToLocal === 'function') {
        return helpers.formatUSDToLocal(amount);
    }
...
async function downloadCardDetails(id) {
    ...
    a.href   = url;
    a.download = 'West Haven Bank-card-' + n.slice(-4) + '.txt';
    a.click();
